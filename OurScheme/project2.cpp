...
class Functions
{
  ...
  map<string,string> symbolMap ; // map symbol 
  ...
  EXP List_qmark() ; // list?
  EXP Null_qmark() ; // null?
  EXP Integer_qmark() ; // integer?
  EXP Real_qmark() ; // real? 
  EXP Number_qmark() ; // number?
  ...
  void EvalSEXP( string funcName, EXP * expHead ) 
  {
    ...
    else if ( funcName == "string-append" )
    {
      String_append() ;
    } // else if 
    else if ( funcName == "string>" )
